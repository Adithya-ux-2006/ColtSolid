...
export function Login() {
  ...
  return (
    <PageWrapper className="min-h-screen bg-cream flex flex-col items-center justify-center p-6">
      <div className="w-full max-w-md bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            ...
            className="w-full py-3.5 bg-coral text-white rounded-xl font-bold shadow-coral hover:bg-coral-dark transition-all disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center"
          >
