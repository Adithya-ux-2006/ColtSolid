  ...
  return (
    <PageWrapper className="min-h-screen bg-cream flex flex-col">
      ...
      <section className="relative pt-32 pb-20 px-6 lg:px-8 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-coral-light/20 to-teal-light/20 -z-10" />
        
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <div className="w-16 h-16 mx-auto bg-coral rounded-2xl flex items-center justify-center shadow-coral mb-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <Link 
              to="/register" 
              className="w-full sm:w-auto px-8 py-4 bg-coral text-white rounded-full font-bold text-lg hover:bg-coral-dark transition-all shadow-coral hover:shadow-lg transform hover:-translate-y-1"
            >
              Get Started
            </Link>
            <Link 
              to="/login" 
              className="w-full sm:w-auto px-8 py-4 bg-white text-teal-dark border-2 border-teal rounded-full font-bold text-lg hover:bg-teal/5 transition-all"
            >
              Log In
            </Link>
          </div>
      ...
      {/* Features */}
      <section className="py-24 bg-cream flex-grow">
        <div className="max-w-6xl mx-auto px-6">
      ...
      <footer className="py-8 border-t border-gray-200 bg-white text-center">
        <div className="flex items-center justify-center gap-2 mb-2">
          <div className="w-5 h-5 rounded-md bg-coral flex items-center justify-center text-white font-bold text-xs">C</div>
...
function Feature({ icon: Icon, title, description }) {
  return (
    <div className="text-center">
      <div className="w-16 h-16 mx-auto bg-teal/10 rounded-2xl flex items-center justify-center mb-6 text-teal-dark">
