...
import { LayoutDashboard, Search, Heart, CalendarDays, User, ShieldCheck } from 'lucide-react';
...
export function AppDock() {
  ...
  const items = [
    ...
    { to: '/appointments', icon: CalendarDays, label: 'Appointments', locked: !isAuthenticated },
