...
-- New symptoms
INSERT INTO public.symptoms (id, label, emoji, color) VALUES
...
-- New remedies
INSERT INTO public.remedies (id, name, category, short_description, long_description, how_to_use, warnings, time_to_effect, difficulty, cost, is_featured) VALUES
  ('rem_101', 'Sleep & Stress Reset Routine', 'Lifestyle',
  ...
  ('rem_102', 'Maca Root Supplement', 'Natural',
  ...
  ('rem_103', 'Pelvic Floor Relaxation Exercises', 'Lifestyle',
  ...
  ('rem_104', 'Water-Based Personal Lubricant', 'Conventional',
   ...
   'Immediate', 'Easy', '$', true),
  ('rem_105', 'Vaginal Moisturizer (Non-Hormonal)', 'Conventional',
