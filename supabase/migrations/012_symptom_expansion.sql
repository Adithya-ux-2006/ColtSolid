-- 012_symptom_expansion.sql - Part 1/3: New symptoms + Ayurveda/gap remedies for 16 existing symptoms
BEGIN;
...
ALTER TABLE public.symptom_remedies DROP CONSTRAINT IF EXISTS symptom_remedies_evidence_score_check;
ALTER TABLE public.symptom_remedies DROP CONSTRAINT IF EXISTS symptom_remedies_priority_rank_check;
...
-- Secondary mappings (shared benefits)
INSERT INTO public.remedy_symptoms (remedy_id, symptom_id) VALUES
